...
VOLUME ["/var/lib/postgres/data", "/var/www/devtrac"]

ENV DB_NAME devtrac
ENV DB_USERNAME devtrac
ENV DB_PASS devtrac
ENV DB_HOST 127.0.0.1
ENV DATADIR /var/lib/postgres/data

ENV APP_DIR /var/www/devtrac
ENV VENV /var/www/.virtualenvs/devtrac
ENV ACTIVATE /var/www/.virtualenvs/devtrac/bin/activate
ENV DJANGO_SETTINGS_MODULE devtrac.preset.local_settings
